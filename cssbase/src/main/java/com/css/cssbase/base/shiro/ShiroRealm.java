...
//            log.info("————————身份认证失败——————————IP地址:  "+ oConvertUtils.getIpAddrByRequest(SpringContextUtils.getHttpServletRequest()));
        ...
        return new SimpleAuthenticationInfo(loginUser, token, ByteSource.Util.bytes(loginUser.getSalt()), getName());
    }
    ...
    public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        log.debug("——————————校验token有效———————checkUserTokenIsEffect——————— "+ token);
    ...
    public boolean jwtTokenRefresh(String token, String userName, String passWord) {
        ...
        if (isNotEmpty(cacheToken)) {
            ...
            if (!JwtUtil.verify(cacheToken, userName, passWord)) {
                ...
                log.info("——————————用户在线操作，更新token———————jwtTokenRefresh——————— "+ newAuthorization);
            }
            return true;
        }
        return false;
